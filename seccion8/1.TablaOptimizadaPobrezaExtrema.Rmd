...
tabla_Nacional_PE <- f_tablaMue_PobrezaExtrema(df_parametrostablas = df_parametrostablas_pobrezaExtrema, 
          str_region = "Nacional", cve = 0.022, m = 6)
```
...
```{r, warning=FALSE, message=FALSE}
grilla_zona <- seq(df_parametrostablas_pobrezaExtrema$cve_original[2] - 0.005, df_parametrostablas_pobrezaExtrema$cve_original[2] + 0.005, by =  0.00001)
...
```{r, warning=FALSE, message=FALSE}
grilla_region <- seq(df_parametrostablas_pobrezaExtrema$cve_original[4] - 0.005, df_parametrostablas_pobrezaExtrema$cve_original[4] + 0.005, by =  0.00001)
...
El tamaño de muestra necesario para un año deberá ser de 5644 a nivel nacional, urbano y regional. El número total de hogares a realizar es de: `r 5644 * 6` hogares
